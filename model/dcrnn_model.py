...
class DCRNNModel(object):
    def __init__(self, is_training, batch_size, scaler, adj_mx, **model_kwargs):
        ...
        with tf.variable_scope('DCRNN_SEQ'):
            ...
            # Unattempting to use uninitialized value
            # print(final_state[0].eval())
            # Attempting to use uninitialized value DCRNN/DCRNN_SEQ/rnn_decoder/multi_rnn_cell/cell_1/dcgru_cell/gates/weights
            # exit()
